...
public class UserServiceImpl extends AbstractCommonService<User> implements UserService {
    ...
    @Override
    public PaginatedResponseDto<UserDto> getAllUsers(PageableInput input) {

        Page<@NonNull User> page = findAll(input);

        Page<@NonNull UserDto> result = page.map(this::mapToDto);
